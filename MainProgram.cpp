...
public:
    ...
    double getArea() const { return abs(topLeft.x-bottomRight.x)*abs(topLeft.y-bottomRight.y); }  // stub

    // TODO 10: const display()
    void  display() const {
        cout<<"Point of TopLeft :"<<"("<<topLeft.x<<","<<topLeft.y<<")"<<endl;
        cout<<"Point of BottomRigth :"<<"("<<bottomRight.x<<","<<bottomRight.y<<")"<<endl;
        cout<<"Width of Rectangle :"<<abs(topLeft.x-bottomRight.x)<<endl;
        cout<<"Height of Rectangle :"<<abs(topLeft.y-bottomRight.y)<<endl;
        cout<<"Area of Rectangle :"<<abs(topLeft.x-bottomRight.x)*abs(topLeft.y-bottomRight.y)<<endl;
...
int main() {
    ...
    cout << "Complete the TODOs above!" << std::endl;
    return 0;
}
